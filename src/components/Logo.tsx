...
export function Logo({ variant = 'default', className = "h-8" }: LogoProps) {
    const textColor = variant === 'white' ? '#FFFFFF' : '#333333';
    ...
    return (
        <svg viewBox="0 0 800 175" className={className} xmlns="http://www.w3.org/2000/svg">
            <g fill={textColor}>
                <path d="M403.66,171.69l-10-28.49h-57l-9.78,28.49H294.09L350.17,21.5h29.14L437.2,171.69ZM365,61.19l-18.66,53.73H383.9Z" />
